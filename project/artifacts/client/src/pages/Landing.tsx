    ...
    <div className="min-h-screen bg-cream text-dark font-sans">
      ...
      <section className="grid lg:grid-cols-2 min-h-[85vh]">
        <div className="flex flex-col justify-center px-8 md:px-16 py-20">
          ...
          <p className="text-lg text-black/70 max-w-xl leading-relaxed mb-10">
            AthletiGolf combines performance-focused fitness tracking with advanced golf insights to help athletes and everyday gym-goers improve with purpose.
          </p>
        ...
        <div className="relative overflow-hidden">
          <img
            src="https://images.pexels.com/photos/46024/pexels-photo-46024.jpeg?auto=compress&cs=tinysrgb&w=1400"
            alt="Golfer"
      ...
      <section className="px-8 md:px-16 py-10 grid md:grid-cols-4 gap-5 border-y border-black/10 bg-white/30">
        {[
          ...
          <div key={index} className="bg-white rounded-3xl p-6 shadow-sm border border-black/5">
